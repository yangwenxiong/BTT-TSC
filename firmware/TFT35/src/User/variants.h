...
//LCD Backlight pin (PWM can adjust brightness)
  ...
  #define LCD_LED_SUPPORT
  #define LCD_LED_RCC   RCC_APB2Periph_GPIOD
...
//need CS/SCK/MISO/MOSI for Software SPI, and TPEN for pen interrupt
  ...
  #define XPT2046_SCK_PORT  GPIOE
  #define XPT2046_SCK_PIN   GPIO_Pin_5
  #define XPT2046_MISO_PORT GPIOE
  #define XPT2046_MISO_PIN  GPIO_Pin_4
  #define XPT2046_MOSI_PORT GPIOE
  #define XPT2046_MOSI_PIN  GPIO_Pin_3
  #define XPT2046_TPEN_PORT GPIOC
  #define XPT2046_TPEN_PIN  GPIO_Pin_13
#else
...
#elif defined(TFT35_V3_0)  
  #define SD_CD_SUPPROT
  #define SD_CD_RCC     RCC_APB2Periph_GPIOC
...
//W25Qxx SPI pins
  ...
  #define W25Qxx_SPEED  0
  #define W25Qxx_SPI    _SPI3
  #define SPI3_CS_RCC   RCC_APB2Periph_GPIOB
...
//LCD Encoder support
  ...
  #define LCD_ENCODER_RCC RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOC
  #define LCD_ENCA_PORT   GPIOA
  #define LCD_ENCA_PIN    GPIO_Pin_8
  #define LCD_ENCB_PORT   GPIOC
  #define LCD_ENCB_PIN    GPIO_Pin_9
  #define LCD_BTN_PORT    GPIOC
  #define LCD_BTN_PIN     GPIO_Pin_8
#endif
